  ...
  return (
    <div className="flex flex-col items-center space-y-6 p-40">
      ...
      <div className="flex gap-6">
        <button className="btn-default" data-cy="pick-movie" onClick={() => onSelect("movie")}>Movies</button>
        <button className="btn-default" data-cy="pick-tv" onClick={() => onSelect("tv")}>TV Shows</button>
      </div>
    </div>
  );
}
