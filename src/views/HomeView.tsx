        ...
        <div className="page-background">
            <div className="mt-5 col-start-3 row-start-3 flex flex-col bg-white dark:bg-gray-800 p-5 rounded-lg items-center-safe">
                ...
                <div className="flex flex-col space-y-4 mt-4">
                    <button data-cy="start-guess" onClick={onStartGuessTheMovie}>Guess the Movie</button>
                    <button data-cy="start-higher" onClick={onStartHigherLower}>Higher / Lower</button>
                    <button data-cy="start-sort" onClick={onStartSortGame}>Sort Game</button>
            </div>
            </div>
        </div>
    );
