    ...
    return (
        <div className="page-background flex flex-col items-center p-6">
            ...
            <div className="flex items-center gap-2 mb-6">
                <button className="btn--default absolute left-6" onClick={goToHome}>
                    Game Hub
                </button>

                <h1 className="text-3xl font-bold text-black dark:text-white">Higher or Lower?</h1>
                <button
                    ...
                    {loading ? (
                        ...
                        <div className="bg-white dark:bg-gray-800 p-8 rounded-lg w-full max-w-7xl grid grid-cols-[1fr_auto_1fr] items-start gap-x-6">
                            <div className="flex flex-col items-center gap-1">
                                <h3 className="text-black dark:text-white text-xl font-sans font-bold text-center w-full">
                            ...
                            <div className="flex flex-col items-center justify-between h-3/7">
                                <h2 className="mt-4 w-full max-w-xs bg-col2 text-white font-bold text-center text-lg px-4 py-2 rounded-lg shadow">
                                    Current Score: {score}
                                </h2>
                            ...
                            <div className="flex flex-col items-center gap-1">
                                ...
                                />
                                <p className="text-black dark:text-white text-2xl font-sans font-bold">
                                    {showRatings ? `Rating: ${contentB?.vote_average}` : "Rating: ???"}
                                </p>
                                <div className="flex gap-3 mt-4">
                                    <button className="btn--default" onClick={() => onGuess("higher")} disabled={buttonsDisabled}>
                                        Higher
                                    </button>
                                    <button className="btn--default" onClick={() => onGuess("lower")} disabled={buttonsDisabled}>
                                        Lower
                                    </button>
                                </div>
                            </div>
