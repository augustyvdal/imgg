                ...
                {loading ? (
                    ...
                    <>
                        <div className="rounded-xs p-6 bg-col1/0 space-y-5 w-[max:100%]">
                            ...
                            <motion.div className="border-t border-white/10 my-3 origin-left" />
                        ...
                        {message && (
                            <p className="text-lg font-medium text-col1 mb-4">{message}</p>
                        )}
                    </>
                )}
            </div>
                ...
                {!gameOver ? (
                    ...
                    >
                        ...
                        {user ? (
                            ...
                            <>
                                <p className="text-col4 text-lg mt-4">
                                    Create an account to <span className="font-bold text-col1">compete on the leaderboards!</span>
                                </p>
                                <div className="flex flex-col sm:flex-row gap-3 mt-4">
                                    <button
                                        onClick={onRestart}
